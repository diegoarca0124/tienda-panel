...
@Component({
	...
	imports: [TopbarComponent, SidebarComponent, CommonModule, RouterModule, FormsModule, NgSelectModule, AlertComponent, ValidationPopoverComponent, TextareaAutoresizeDirective],
