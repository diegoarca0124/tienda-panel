export const productFormHelp = {
  ...
  priceDiscount: "Si existe, reemplaza el precio regular.",
  minStock: "Para generar alerta de reposición.",
  maxStock: "Para evitar sobrealmacenamiento.",
  ...
  weightUnit: "Unidad de peso (ej: gr, kg, lb).",
  
  height: "Altura total del producto.",
  width: "Ancho total del producto.",
  length: "Profundidad del producto.",
  dimensionUnit: "Unidad de medida usada para las dimensiones.",
  ...
  minStorageTemp: "Temperatura mínima para almacenar.",
  maxStorageTemp: "Temperatura máxima para almacenar.",
  storageTempUnit: "Unidad de medida para la temperatura.",
  ...
  handlingDays: "Número de días para preparar el producto antes del envio.",
  packageType: "Tipo de empaque utilizado para el envío del producto.",
