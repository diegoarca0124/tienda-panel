...
@Component({
  selector: 'app-menu-select-subcat',
  imports: [
    RouterModule,
    CommonModule,
    FormsModule,
  ...
  templateUrl: './menu-select-subcat.component.html',
  styleUrl: './menu-select-subcat.component.css'
})
export class MenuSelectSubcatComponent {
