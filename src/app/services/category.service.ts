...
import { GetCategoriesRESI, GetCategoriesWithSubcategoriesRESI, MoveSubcategoryRESI, UpdateCategoriesStatusRESI, UpdateCategoryStatusRESI } from '@app/pages/categories/interfaces/response.interface';
